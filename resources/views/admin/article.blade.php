            ...
            <div class="col-md-8 mx-auto">
                <form action="{{route('article.update',$article->slug)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="editor" class="form-control cke_rtl @error('content') is-invalid @enderror" cols="30" rows="10">{{$article->content}}</textarea>
                        @error('content')
                            <strong class="invalid-feedback">
                                {{$message}}
                            </strong>
