    ...
    return (
        <section className={styles.container}>
            ...
            <div className={styles.cards}>
                ...
                <Card1 className="bg-[url('/resources/assets/rectangle2.jpg')] bg-auto" icon={bolt2} title="مهندسین مشاور" desc="مهندسین مشاور با بهره‌گیری از تخصص و تجربه، در تمامی مراحل طراحی، نظارت و مشاوره فنی پروژه‌های ساختمانی همراه شما هستند تا بهترین راهکارهای مهندسی را ارائه دهند"/>
